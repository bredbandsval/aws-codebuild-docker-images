...
This is the Bredbandsval clone. We have modified the Ubuntu standard 7.0 image to install Postgres 14 and remove tools we don't need. This is needed to build the API repo since it runs test against a Postres database.
See the readme in api for more info regarding how to build an image.
